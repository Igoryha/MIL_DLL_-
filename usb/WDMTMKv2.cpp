/*****************************************************************************/
/*    WDMTMK API v4.00 for Microsoft Windows. ELCUS, 1998, 2011.             */
/*    Interface to driver TMK1553B.SYS v4.00                                 */
/*    Interface to driver USB_TA_DRV.dll v1.7                                */ 
/*    for Windows 98/ME/2000/XP/Vista/7 (32 bit only)                        */
/*****************************************************************************/
  ...
  if(hUSBDrvDll != NULL)
  {
    ...
    if(loaded)
    {
      ...
      for(iTMK = 0; iTMK <= MAX_USBTA_NUM; ++iTMK)
      {
        ...
        _hVTMK4VxD[nTMKb+1+iTMK] = CreateFileA(tmkName,
                                 GENERIC_READ | GENERIC_WRITE,
                                 0,
                                 NULL,
                                 OPEN_EXISTING,
